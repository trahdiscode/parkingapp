...
@keyframes pulse-gold {
    0%, 100% { opacity: 1; box-shadow: 0 0 10px #D4AF37; }
    50% { opacity: 0.6; box-shadow: 0 0 4px #D4AF37; }
}
.admin-title {
    ...
    background: linear-gradient(180deg, #FFFFFF 0%, #E8C96A 50%, #B8922A 100%);
...
.admin-tabs .stTabs [data-baseweb="tab-list"] {
...
.admin-tabs .stTabs [data-baseweb="tab"] {
...
.admin-tabs .stTabs [aria-selected="true"] {
    background: rgba(212,175,55,0.1) !important;
    color: #D4AF37 !important;
    box-shadow: 0 0 0 1px rgba(212,175,55,0.25) inset !important;
}
.admin-inputs .stTextInput input {
    background: #0D0D10 !important;
...
.admin-inputs .stTextInput input:focus {
    border-color: rgba(212,175,55,0.5) !important;
    box-shadow: 0 0 0 3px rgba(212,175,55,0.08) !important;
}
.admin-inputs .stTextInput > label {
    color: #D4AF37 !important;
    font-size: 0.62rem !important;
    letter-spacing: 0.14em !important;
}
.admin-btn .stButton > button[kind="primary"] {
    background: linear-gradient(135deg, #C9A227 0%, #E8C96A 50%, #C9A227 100%) !important;
    ...
    min-height: 48px !important;
    border-radius: 10px !important;
    box-shadow: 0 4px 24px rgba(201,162,39,0.3), 0 1px 0 rgba(255,255,255,0.15) inset !important;
    max-width: 520px !important;
}
.admin-btn .stButton > button[kind="primary"]:hover {
    box-shadow: 0 8px 32px rgba(201,162,39,0.45) !important;
}
.admin-btn .stButton > button[kind="secondary"] {
...
.admin-btn .stButton > button[kind="secondary"]:hover {

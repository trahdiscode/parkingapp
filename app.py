...
if not user_has_active_or_future_booking: # Only show if no active/future bookings
    ...
    st.info("You already have an active or upcoming parking session. Please manage existing bookings first to book a new slot.", icon="ℹ️")import streamlit as st
import sqlite3
import hashlib
from datetime import datetime, date, timedelta
from streamlit_autorefresh import st_autorefresh
...
I need to improve the beginning part. I've attached the screenshot of this. Make sure that You've improved the UI and send the updated code
